...
MelonDSAndroid::EmulatorConfiguration MelonDSAndroidConfiguration::buildEmulatorConfiguration(JNIEnv* env, jobject emulatorConfiguration) {
    ...
    jclass consoleTypeEnumClass = env->FindClass("com/drasticds/emulator/domain/model/ConsoleType");
    jclass audioBitrateEnumClass = env->FindClass("com/drasticds/emulator/domain/model/AudioBitrate");
    jclass audioInterpolationEnumClass = env->FindClass("com/drasticds/emulator/domain/model/AudioInterpolation");
    jclass audioLatencyEnumClass = env->FindClass("com/drasticds/emulator/domain/model/AudioLatency");
    jclass micSourceEnumClass = env->FindClass("com/drasticds/emulator/domain/model/MicSource");
    jclass videoRendererEnumClass = env->FindClass("com/drasticds/emulator/domain/model/VideoRenderer");
    jclass renderConfigurationClass = env->FindClass("com/drasticds/emulator/domain/model/RendererConfiguration");

    jmethodID uriToStringMethod = env->GetMethodID(uriClass, "toString", "()Ljava/lang/String;");

    jobject firmwareConfigurationObject = env->GetObjectField(emulatorConfiguration, env->GetFieldID(emulatorConfigurationClass, "firmwareConfiguration", "Lcom/drasticds/emulator/domain/model/FirmwareConfiguration;"));
    jobject rendererConfigurationObject = env->GetObjectField(emulatorConfiguration, env->GetFieldID(emulatorConfigurationClass, "rendererConfiguration", "Lcom/drasticds/emulator/domain/model/RendererConfiguration;"));
    ...
    jobject consoleTypeEnum = env->GetObjectField(emulatorConfiguration, env->GetFieldID(emulatorConfigurationClass, "consoleType", "Lcom/drasticds/emulator/domain/model/ConsoleType;"));
    ...
    jobject audioInterpolationEnum = env->GetObjectField(emulatorConfiguration, env->GetFieldID(emulatorConfigurationClass, "audioInterpolation", "Lcom/drasticds/emulator/domain/model/AudioInterpolation;"));
    ...
    jobject audioBitrateEnum = env->GetObjectField(emulatorConfiguration, env->GetFieldID(emulatorConfigurationClass, "audioBitrate", "Lcom/drasticds/emulator/domain/model/AudioBitrate;"));
    jint audioBitrate = env->GetIntField(audioBitrateEnum, env->GetFieldID(audioBitrateEnumClass, "bitrateValue", "I"));
    jobject audioLatencyEnum = env->GetObjectField(emulatorConfiguration, env->GetFieldID(emulatorConfigurationClass, "audioLatency", "Lcom/drasticds/emulator/domain/model/AudioLatency;"));
    jint audioLatency = env->GetIntField(audioLatencyEnum, env->GetFieldID(audioLatencyEnumClass, "latencyValue", "I"));
    jobject micSourceEnum = env->GetObjectField(emulatorConfiguration, env->GetFieldID(emulatorConfigurationClass, "micSource", "Lcom/drasticds/emulator/domain/model/MicSource;"));
    jint micSource = env->GetIntField(micSourceEnum, env->GetFieldID(micSourceEnumClass, "sourceValue", "I"));
    jobject videoRendererEnum = env->GetObjectField(rendererConfigurationObject, env->GetFieldID(renderConfigurationClass, "renderer", "Lcom/drasticds/emulator/domain/model/VideoRenderer;"));
