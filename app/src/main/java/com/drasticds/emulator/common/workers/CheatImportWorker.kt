package com.drasticds.emulator.common.workers
...
import com.drasticds.emulator.DrasticDSEmulatorApplication
import com.drasticds.emulator.R
import com.drasticds.emulator.common.cheats.CheatDatabaseParser
import com.drasticds.emulator.common.cheats.CheatDatabaseParserListener
import com.drasticds.emulator.common.cheats.ProgressTrackerInputStream
import com.drasticds.emulator.common.cheats.XmlCheatDatabaseParser
...
class CheatImportWorker @AssistedInject constructor(
    ...
    private fun createForegroundInfo(gameName: String?, progress: Int, indeterminate: Boolean): ForegroundInfo {
        val notification = NotificationCompat.Builder(applicationContext, DrasticDSEmulatorApplication.NOTIFICATION_CHANNEL_ID_BACKGROUND_TASKS)
