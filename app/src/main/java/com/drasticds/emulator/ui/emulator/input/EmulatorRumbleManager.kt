...
import com.drasticds.emulator.common.vibration.VibratorDelegate
...
class EmulatorRumbleManager(
     ...
     *
     * The [com.drasticds.emulator.ui.emulator.input.EmulatorRumbleManager.RumbleEventMixer] attempts to create a smooth rumble feeling by receiving the emulator events and
